...
<?php if ( $results['category']->id ) { ?>
    <p><a href="<?= \ItForFree\SimpleMVC\Router\WebRouter::link('Admin/deleteCategory') ?>&amp;categoryId=<?php echo $results['category']->id ?>" onclick="return confirm('Delete This Category?')">
